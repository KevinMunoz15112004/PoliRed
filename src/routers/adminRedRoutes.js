...
router.put('/perfil/admin-red/actualizar', verifyToken, requireRole('admin_red'), actualizarPerfilAdminRed)
router.put('/perfil/admin-red/actualizar/password', verifyToken, requireRole('admin_red'), actualizarPasswordAdminRed)
...
router.delete('/publicaciones/admin/eliminar/:id', verifyToken, requireRole('admin_red'), eliminarPublicacionAdmin)
router.get('/publicaciones/articulos/listar/admin', verifyToken, requireRole('admin_red'), listarArticulosPorRedAdmin)
router.delete('/publicaciones/admin/articulo/eliminar/:id', verifyToken, requireRole('admin_red'), eliminarArticuloAdmin)
...
router.delete('/admin/estudiantes/eliminar/:estudianteId', verifyToken, requireRole('admin_red'), eliminarEstudianteDeRed)
